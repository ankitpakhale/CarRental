...
const about = () => {
  return (
    <>
    <div className="logo">
      <img src={require("../Assets/images/logos.png")} height="100%" width="100%" />
    </div>
      ...
      <div className="row">
        <div className="col-8">
          ...
          <blockquote className="text-muted mt-4">
            ...
            voluptatem at tempore unde quasi dicta nemo! Iusto nemo odit dolorem
            deserunt reiciendis? Lorem ipsum dolor, sit amet consectetur
            adipisicing elit. Id, possimus amet quia exercitationem dignissimos
            aperiam esse. Sequi voluptatem at tempore unde quasi dicta nemo!
            Iusto nemo odit dolorem deserunt reiciendis?
          </blockquote>
          <blockquote className="text-muted mt-4">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Id,
            possimus amet quia exercitationem dignissimos aperiam esse. Sequi
        ...
        <div className="row">
          ...
          <div className="col-4">
            <blockquote className="bq1">
              <p>
                <i
                  >Lorem ipsum dolor sit amet, consectetur adipiscinger elit. In
                  mollis erat mattis neque facilisis, sit ameter ultricies erat
                  rutrum. Cras facilisis, nulla vel viver auctor, leo magna...
                </i>
              </p>
            ...
            <blockquote className="bq1">
              <p>
                <i
                  ...
                  mollis erat mattis neque facilisis, sit ameter ultricies erat
                  rutrum. Cras facilisis, nulla vel viver auctor, leo magwe...
                </i>
              </p>
          ...
          <div className="col-4">
            <blockquote className="bq1">
              <p>
                <i
                  >Gorem ipsum dolor sit amet, consectetur adipiscinger elit. In
                  mollis erat mattis neque facilisis, sit ameter ultricies erat
                  rutrum. Cras facilisis, nulla vel viver auctoro
                  magndales...</i
                >
              </p>
