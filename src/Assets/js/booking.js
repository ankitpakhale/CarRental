      ...
      var $this = $(this),
        ...
        object = {
          ...
          createCustomFileds: function () {
            var wrapper =
              '<div class="' +
              String(object.wrapperClass).substr(1) +
              '"></div>';
              ...
              switch (el.type) {
                ...
                case object.types.select:
                  ...
                  if (wpr.find(".manual").length) {
                    ...
                    wpr
                      .find(".transformSelectDropdown li")
          ...
          validateData: function () {
            ...
            $.each(validationResults, function (i, r) {
              var wpr = $(validationResults[i].failingElements[0]).parents(
                object.wrapperClass
              );
              if (!wpr.hasClass(className(object.invalidClass))) {
                wpr
                  ...
                  .append(
                    '<strong class="' +
                      className(object.errorMessageClass) +
                      '">' +
          ...
          submitData: function () {
            $.ajax({
              ...
              success: function (results) {
                $this
                  .find(object.successMessageClass)
                  .remove()
                  .end()
                  .find('[data-type="submit"]')
                  .after(
                    '<p class="' +
                      className(object.successMessageClass) +
                      '">' +
                  ...
                  .stop(true)
                  .slideUp(0)
                  .slideDown(object.writeFieldsDataDefaults)
                  .delay(4000)
                  .slideUp();
              },
            });
